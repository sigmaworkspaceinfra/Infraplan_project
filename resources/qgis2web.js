...
map.getView().fit([4362846.532370, 1011652.528839, 12931113.207773, 5236519.199814], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Infraplan Project</h2>';
        return titleElement;
    })(),
