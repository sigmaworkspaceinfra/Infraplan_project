...
lyr_WaterSupplyDrinkingWorks_1.set('fieldLabels', {'Name': 'inline label - always visible', 'Descri.': 'no label', });
lyr_Architectural3DMapping_2.set('fieldLabels', {'Name': 'inline label - always visible', 'Descri.': 'no label', });
lyr_CityDevelopmentPlanCitySanitationPlan_3.set('fieldLabels', {'Descri.': 'inline label - always visible', 'Name': 'no label', });
lyr_SolarEnergy_4.set('fieldLabels', {'Name': 'inline label - visible with data', 'Descri.': 'no label', });
lyr_UndergroundDrainageScheme_5.set('fieldLabels', {'Name': 'inline label - visible with data', 'Descri.': 'no label', });
lyr_HydraulicModelStudies_6.set('fieldLabels', {'Name': 'inline label - visible with data', 'Descri.': 'inline label - visible with data', 'Photos': 'inline label - visible with data', 'Photo': 'inline label - visible with data', });
